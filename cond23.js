...
if(venda <=  30){
    console.log("Você ganhou 250,00 R$")
}
else if( venda >= 31 && venda <=80){
    console.log("Você ganhou 500,00 R$")
}
else if(venda >= 80 && venda <= 200){
    console.log("Você ganhou 1.000 R$")
}
else if(venda >= 200 ){
    console.log("Você vai ganha 2.000 R$")
}
