...
// Utilizando a estrutura "Para... Faça..." (for)
for (let i = 1; i <= 100; i++) {
    console.log(i);
}
// Utilizando a estrutura "Enquanto... Faça..." (while)
let i = 1;
while (i <= 100) {
    console.log(i);
    i++;
...
/*2. Suponha que você precise criar um programa para imprimir uma lista de todos os
